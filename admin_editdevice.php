...
<body>
    ...
    <div class="center">
        ...
        ?>
        <form class="Form" action="templates/adminphp/edit.php" method="post">
            
        <div class="ID" name="InventoryID" required>
                <?php
                    echo "<input type='text' id='inventory-id' name='InventoryID' value='$results[InventoryID]' required readonly style='display:none;' />";
        ?>
            ...
            <div class="txtfield">
                <select name="Category" id="Category" class="option">
                    <option value="" disabled selected hidden>Kategorija</option>
                        ...
                        {
                            echo "<option>" . $results["ID"] . " - ". $results["Name"] . "</option>";
                        }
                        ?>
                </select>
            </div>
